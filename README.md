...
Once Node.js and npm are installed download and unzip the CTK-TMF653-ServiceTest-R18 ZIP file within your test directory.
...
>https://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/serviceTestManagement/v4/serviceTest

You should input:
>https://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/serviceTestManagement/v4/
...
![CTK Example Image](https://github.com/tmforum-rand/CTK-TMF653-ServiceTest-R18/blob/master/images/Output-Example.png)
