...
var DefaultURL = "${APIDEFAULTURL}/tmf-api/serviceTestManagement/v4/";
var schema;
var hostname;
var port;
var APIRelativeAddress;
var statusCode;
const exampleEndPoint = "/serviceTest";
const rl = readline.createInterface({
  input: process.stdin,
  output: process.stdout
});

console.log("////////////////////////////////////////////////////////////////////////\nWelcome to the Conformance Test Kit for TMF653 ServiceTest R18\n");
getURL();
...
function getURL(){
    ...
    'https://apictk-service-test-management-v4-0-0.mybluemix.net/tmf-api/serviceTestManagement/v4/serviceTest\n'+
    'becomes\n'+
    'https://apictk-service-test-management-v4-0-0.mybluemix.net/tmf-api/serviceTestManagement/v4\n>', (answer) => {
    DefaultURL = answer;
    rl.close();
    isURLValid(answer);
...
function exportEnvironment(url){
    ...
    envJson.values.forEach(element => {
        if (element.key == "ServiceQualificationAPI"){
            element.value = url;
        }
    });
...
function runNewman(){
    ...
    newman.run({
        collection: require('./CTK-TMF653-ServiceTest-R18.5.postman_collection.json'),
